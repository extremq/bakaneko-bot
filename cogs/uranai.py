...
class UranaiCog(commands.Cog):
    ...
    async def uranai_command(self, interaction: discord.Interaction):
    ...
    @discord.app_commands.command(
        name="uranai_stats",
        description="運勢の履歴や統計情報を確認します。"
    )
    async def uranai_stats_command(self, interaction: discord.Interaction):
        db_cursor = self.cursor
